...
export class WsPressureMoniteringService{
    public onNewTimeValueResponse = new EventEmitter<{ params: PressureDataUpdatesRequestParameters, value: TimeValue }>(true); // subscribe and TODO something

    private readonly requestDictionary: { [key: string]: { pressureRequest: WSRequest, params: PressureDataUpdatesRequestParameters } } = {};
    ...
    private sendRequest(request: WSRequest,params: PressureDataUpdatesRequestParameters) {
      ...
      this.requestDictionary[key] = {pressureRequest:request, params:params};
