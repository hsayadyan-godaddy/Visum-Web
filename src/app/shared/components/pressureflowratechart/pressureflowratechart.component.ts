...
export class PressureflowratechartComponent implements OnInit {
  ...
  constructor(
    ...
    private wsPressureService: WsPressureMoniteringService,
  ) { }
  ...
  async getFlowRateSensors() {
    ...
    this.flowRateSensorResponse = await this.productionMonitoringService.getFlowRateSensorsAsync(
      this.flowRateSensorCmd,
    );
  }
  ...
  async getPressureSensors() {
    ...
    this.pressureSensorsResponse = await this.productionMonitoringService.getPressureSensorsAsync(
      this.pressureSensorsCommand,
    );
  }
  ...
  async getPressureHistoryData(period: Periodicity) {
    ...
    this.bhppressureHistoryDataResponse = await this.productionMonitoringService
      .getPressureHistoryDataAsync(
        this.pressureHistoryDataCommand,
      );
    ...
    this.p1pressureHistoryDataResponse = await this.productionMonitoringService
      .getPressureHistoryDataAsync(
        this.pressureHistoryDataCommand,
      );
    ...
    this.p2pressureHistoryDataResponse = await this.productionMonitoringService
      .getPressureHistoryDataAsync(
        this.pressureHistoryDataCommand,
      );
    ...
    this.p3pressureHistoryDataResponse = await this.productionMonitoringService
      .getPressureHistoryDataAsync(
        this.pressureHistoryDataCommand,
      );
  ...
  async getFlowRateHistoryData(period: Periodicity) {
    ...
    this.flowRateHistoryDataResponse = await this.productionMonitoringService
      .getFlowRateHistoryDataAsync(
        this.flowRateHistoryDataCommand,
      );
    ...
    if (
      this.flowRateHistoryDataResponse.flowRateData
    ...
    return [
      {
        ...
        type: 'scatter',
        mode: 'lines',
        name: this.pressureSensorsResponse.info[0].name,
        marker: { color: 'yellow' },
      },
      {
        x: this.xP1Array,
        ...
        type: 'scatter',
        mode: 'lines',
        name: this.pressureSensorsResponse.info[1].name,
        marker: { color: 'green' },
      },
      {
        x: this.xP2Array,
        ...
        type: 'scatter',
        mode: 'lines',
        name: this.pressureSensorsResponse.info[2].name,
        marker: { color: 'red' },
      },
      {
        x: this.xP3Array,
        ...
        type: 'scatter',
        mode: 'lines',
        name: this.pressureSensorsResponse.info[3].name,
        marker: { color: 'blue' },
      },
      {
        x: this.xArray,
        ...
        type: 'scatter',
        mode: 'lines',
        name: this.flowRateSensorResponse.info[0].name,
        marker: { color: 'black' },
        yaxis: 'y2',
